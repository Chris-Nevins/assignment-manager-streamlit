...
if "inventory" not in st.session_state:
    st.session_state["inventory"] = data_manager.load_data(Path("smark_kiosk/inventory.json"))

if "orders" not in st.session_state:
    st.session_state["orders"] = data_manager.load_data(Path("smark_kiosk/orders.json"))
